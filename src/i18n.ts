export const translations = {
  ar: {
    ...
    heroDesc: 'توزيعات وهدايا مصممة بعناية لكل مناسبة، من الفكرة الأولى حتى أدق تفصيلة.',
    ...
    occasionsTitle: 'اختر مناسبتك', occasionsSub: 'لكل لحظة طابعها الخاص', occasionsEyebrow: 'المناسبات',
    featuredTitle: 'اختياراتنا المميزة', featuredEyebrow: 'اختياراتنا',
    featuredSub: 'كل تفصيلة تحكي قصة — اختر ما يناسبك',
    ...
    newsDesc: 'سجّل لتكون أول من يعرف بالعروض الجديدة والتخفيضات الحصرية.',
    newsBtn: 'اشترك', newsPlaceholder: 'بريدك الإلكتروني',
    newsDone: 'تم الاشتراك بنجاح!',
    faqTitle: 'الأسئلة الشائعة', faqEyebrow: 'الأسئلة', faqDesc: 'أسئلة شائعة وإجاباتها.', faqNone: 'مفيش أسئلة شائعة بعد.',
    footerDesc: 'تفاصيل بسيطة تصنع لحظات لا تُنسى. توزيعات وهدايا مخصصة لجميع مناسباتك في مصر.',
    quickLinks: 'روابط سريعة', contactUs: 'تواصل معنا', shopByOccasion: 'تصفح حسب المناسبة', contactDesc: 'تواصل معنا وهنساعدك تعمل الطلب المخصص المثالي.',
    ...
    sortBy: 'الترتيب', price: 'السعر', addToCart: 'أضف للسلة', shopAllFavors: 'كل التوزيعات',
    ...
    cartEmpty: 'السلة فارغة', continueShopping: 'تابع التسوق',
    ...
    ordersEmpty: 'لا توجد طلبات بعد', actionOrder: 'ابدأ التسوق',
    ...
    yourNamePlaceholder: 'اكتب اسمك...', yourReviewPlaceholder: 'اكتب رأيك في المنتج...',
    ...
    // General
    noResults: 'لا توجد نتائج', tryDifferent: 'جرّب كلمة أخرى أو غيّر القسم',
    ...
    noCustomers: 'لا يوجد عملاء بعد. ستضيف الطلبات العملاء تلقائياً.',
    ...
    // Product not found
    productNotFound: 'المنتج غير موجود', goToShop: 'الذهاب للمتجر', pageNotFound: 'الصفحة دي مش موجودة',
    // Coupons
    coupons: 'الكوبونات', couponCode: 'كود الخصم', addCoupon: 'إضافة كوبون', editCoupon: 'تعديل كوبون',
    discountType: 'نوع الخصم', percent: 'نسبة مئوية', fixed: 'مبلغ ثابت', minOrder: 'الحد الأدنى للطلب', discountValueLabel: 'القيمة',
  ...
  en: {
    ...
    occasionsTitle: 'Choose Your Occasion', occasionsSub: 'Every moment has its unique character', occasionsEyebrow: 'Occasions',
    ...
    faqTitle: 'Frequently Asked Questions', faqEyebrow: 'FAQ', faqDesc: 'Common questions and their answers.', faqNone: 'No FAQs yet.',
    footerDesc: 'Little details that make unforgettable moments. Custom favors and gifts for all your happy occasions in Egypt.',
    quickLinks: 'Quick Links', contactUs: 'Contact Us', shopByOccasion: 'Shop by Occasion', contactDesc: 'Reach out and we will help you create the perfect custom order.',
    ...
    sortBy: 'Sort', price: 'Price', addToCart: 'Add to Cart', shopAllFavors: 'All Favors',
    ...
    yourNamePlaceholder: 'Enter your name...', yourReviewPlaceholder: 'Write your review...',
    ...
    // Product not found
    productNotFound: 'Product not found', goToShop: 'Go to Shop', pageNotFound: 'Page not found',
    // Coupons
    coupons: 'Coupons', couponCode: 'Coupon Code', addCoupon: 'Add Coupon', editCoupon: 'Edit Coupon',
    discountType: 'Discount Type', percent: 'Percentage', fixed: 'Fixed Amount', minOrder: 'Minimum Order', discountValueLabel: 'Value',
